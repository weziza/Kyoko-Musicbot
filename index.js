...
bot.on("message",function(message){
    ...
    if(message.channel.name==undefined){ 
        ...
        //console.log(message.channel.name+" | "+botchannel)
        ...
        if(message.author.id==admin_id&&message.content.startsWith("emoji_id"+"<:")){
            ...
            return bot.channels.find("name", botchannel).send(messagenumber.slice(messagenumber,messagenumber.length-1)); //zeige alles nach replace und lösche das letzte zeichen    
        };
        ...
        if(message.content.indexOf(prefix)){ //message beginnt mit prefix dann / wenn nicht return
            ...
            case prefix+set_skip: // funktioniert 
                ...
                break;
            case prefix+set_pause: // funktioniert
                sgm.pause(message,prefix,voiceConnection,bot_MessChannel); 
                break;
            case prefix+set_resume: // funktioniert
