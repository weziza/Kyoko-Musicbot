...
const wrt = require('./write_temp_file_modul.js')
//----------------------------
...
module.exports={
    ...
    */
    InfoScreen: InfoScreen = (set_playsong,set_searchsong,set_deletesong,set_savesong,set_songliste,set_randomsong,set_purge,set_volume,set_leave,set_resume,set_pause,set_skip,set_queue,set_clean,set_hilfe,set_uhr,set_mega,set_ping,set_url,MessChannel,prefix,RandomColor,max_queue,bot_name) => {
    ...
    var embed = new discord.RichEmbed()
        ...
        return MessChannel.send(embed),exp_main()
    },
    //-----------------------------
    /**
    ...
    */
    ambedMessage: ambedMessage = (InfoText1,InfoText2,MessChannel,RandomColor,bot_name,Thumbimage) => {        
    ...
    * @param  Thumbimage // Thumb Image
    */
    pause_ambedMessage: pause_ambedMessage = (InfoText1,InfoText2, MessChannel,RandomColor,bot_name,Thumbimage) => {
    ...
    * @param  RandomColor // Math color
    */
    sl_ambedMessage: sl_ambedMessage = (InfoText1,InfoText2, MessChannel,RandomColor) => {
        var embed = new discord.RichEmbed()
    ...
    */
    //------------------------------
    play_ambedMessage: play_ambedMessage = (InfoText1,InfoText2,MessChannel,RandomColor,bot_name,Thumbimage,message)=> {         
        ...
        if(!dothis){
            ...
            { 
                // if(Emoji_tVar._idleStart>timer+500){                  
                    ...
                    await MessChannel.bulkDelete(10).catch(err => console.log(err)) 
                    ...
                    if(send_emoji_bar && !emoji_send){ 
                        ...
                        await go(MessChannel,message),exp_main()
                        // send the global embed with emoji
                        // console.log("send")
                    
                    }else{
                        return MessChannel.send(global_embed),exp_main()
